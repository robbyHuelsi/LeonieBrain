...
<<<<<<< HEAD
					main_region_STT_and_Tell_Actions.ordinal()&& stateVector[0].ordinal() <= State.main_region_STT_and_Tell_Actions_s_GeneratedCommand.ordinal();
...
>>>>>>> master
			return stateVector[0].ordinal() >= State.
					xs_DoAllActions.ordinal()&& stateVector[0].ordinal() <= State.xs_DoAllActions__region0_wait.ordinal();
		...
		case xs_DoAllActions__region0_wait:
			return stateVector[0] == State.xs_DoAllActions__region0_wait;
		case xs_GoToOp:
...
<<<<<<< HEAD
	...
	private boolean check_main_region_STT_and_Tell_Actions_s_YesNo_tr1_tr1() {
=======
...
>>>>>>> master
	...
	private boolean check_xs_DoAllActions__region0_wait_tr0_tr0() {
		return true;
	}
...
<<<<<<< HEAD
	...
	private void effect_main_region_STT_and_Tell_Actions_s_YesNo_tr1() {
		exitSequence_main_region_STT_and_Tell_Actions_s_YesNo();
...
>>>>>>> master
	...
	private void effect_xs_DoAllActions__region0_DoAction_tr0() {
		...
		enterSequence_xs_DoAllActions__region0_wait_default();
	}
	...
	private void effect_xs_DoAllActions__region0_wait_tr0() {
		exitSequence_xs_DoAllActions__region0_wait();
...
>>>>>>> master
		...
		sCIHBrain.operationCallback.sendTTS("[blush:false][:-)] Please tell me, what I should do and give me about 10 seconds to think about it. [attentive]");
...
<<<<<<< HEAD
	private void entryAction_main_region_STT_and_Tell_Actions_s_StartSTT() {
		...
		sCISTT.operationCallback.sendSpeechDetectionActions(10);
=======
...
<<<<<<< HEAD
	...
	private void entryAction_main_region_STT_and_Tell_Actions_s_YesNo() {
		timer.setTimer(this, 7, 15 * 1000, false);
...
>>>>>>> master
	...
	private void entryAction_xs_DontDoIt() {
		...
		sCIHBrain.operationCallback.sendTTS("[:-(]It seems to be quite hard to do. I will get to this task at some other time.[:-|]");
	}
...
>>>>>>> master
	...
	private void enterSequence_xs_DoAllActions__region0_wait_default() {
		nextStateIndex = 0;
		stateVector[0] = State.xs_DoAllActions__region0_wait;
	}
...
>>>>>>> master
	...
	private void exitSequence_xs_DoAllActions__region0_wait() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
...
<<<<<<< HEAD
	private void react_main_region_STT_and_Tell_Actions_s_YesNo() {
		if (check_main_region_STT_and_Tell_Actions_s_YesNo_tr0_tr0()) {
			...
			if (check_main_region_STT_and_Tell_Actions_s_YesNo_tr1_tr1()) {
				effect_main_region_STT_and_Tell_Actions_s_YesNo_tr1();
			}
		}
	}
...
>>>>>>> master
	...
	private void react_xs_DoAllActions__region0_wait() {
		if (check_xs_DoAllActions_tr1_tr1()) {
			effect_xs_DoAllActions_tr1();
		} else {
			effect_xs_DoAllActions__region0_wait_tr0();
		}
	}
...
>>>>>>> master
			...
			case xs_DoAllActions__region0_DoAction_Instructions_question_Ask_a_question_Q:
				...
				break;
			case xs_DoAllActions__region0_wait:
				react_xs_DoAllActions__region0_wait();
				break;
			case xs_GoToOp:
				react_xs_GoToOp();
				break;
