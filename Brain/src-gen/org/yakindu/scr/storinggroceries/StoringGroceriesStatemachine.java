...
public class StoringGroceriesStatemachine implements IStoringGroceriesStatemachine {
	...
	public enum State {
		...
		main_region_Composite_panCupboard_tiltCupboard,
		main_region_Composite_panCupboard_tiltCupboard__region0_doors,
		main_region_Composite_panCupboard_tiltCupboard__region0_wait,
		main_region_Composite_panCupboard_tiltCupboard__region0_sync1,
		main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard,
		main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard,
		main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira,
		main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1,
		main_region_Table,
		main_region_Table__region0_lookToFront,
		main_region_Table__region0_sync1,
		main_region_Table__region1_Copy_1_panCupboard,
		main_region_Table__region1_Copy_1_tiltCupboard,
		main_region_Table__region1_sync1,
		main_region_Table__region1_wait_for_Mira,
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_region_Composite_panCupboard_tiltCupboard:
			return stateVector[0].ordinal() >= State.
					main_region_Composite_panCupboard_tiltCupboard.ordinal()&& stateVector[0].ordinal() <= State.main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1.ordinal();
		case main_region_Composite_panCupboard_tiltCupboard__region0_doors:
			return stateVector[0] == State.main_region_Composite_panCupboard_tiltCupboard__region0_doors;
		case main_region_Composite_panCupboard_tiltCupboard__region0_wait:
			return stateVector[0] == State.main_region_Composite_panCupboard_tiltCupboard__region0_wait;
		case main_region_Composite_panCupboard_tiltCupboard__region0_sync1:
			return stateVector[0] == State.main_region_Composite_panCupboard_tiltCupboard__region0_sync1;
		case main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard:
			return stateVector[1] == State.main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard;
		case main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard:
			return stateVector[1] == State.main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard;
		case main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira:
			return stateVector[1] == State.main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira;
		case main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1:
			return stateVector[1] == State.main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1;
		case main_region_Table:
			return stateVector[0].ordinal() >= State.
					main_region_Table.ordinal()&& stateVector[0].ordinal() <= State.main_region_Table__region1_wait_for_Mira.ordinal();
		case main_region_Table__region0_lookToFront:
			return stateVector[0] == State.main_region_Table__region0_lookToFront;
		case main_region_Table__region0_sync1:
			return stateVector[0] == State.main_region_Table__region0_sync1;
		case main_region_Table__region1_Copy_1_panCupboard:
			return stateVector[1] == State.main_region_Table__region1_Copy_1_panCupboard;
		case main_region_Table__region1_Copy_1_tiltCupboard:
			return stateVector[1] == State.main_region_Table__region1_Copy_1_tiltCupboard;
		case main_region_Table__region1_sync1:
			return stateVector[1] == State.main_region_Table__region1_sync1;
		case main_region_Table__region1_wait_for_Mira:
			return stateVector[1] == State.main_region_Table__region1_wait_for_Mira;
	...
	*/
	...
	private boolean check_main_region_Composite_panCupboard_tiltCupboard__region0_doors_tr0_tr0() {
		return sCIHBrain.tTSReady;
	}
	
	private boolean check_main_region_Composite_panCupboard_tiltCupboard__region0_wait_tr0_tr0() {
		return timeEvents[0];
	}
	
	private boolean check_main_region_Composite_panCupboard_tiltCupboard__region0_sync1_tr0_StoringGroceries_main_region__sync1join_check() {
		return isStateActive(State.main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1);
	}
	...
	private boolean check_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1_tr0_StoringGroceries_main_region__sync1join_check() {
		return isStateActive(State.main_region_Composite_panCupboard_tiltCupboard__region0_sync1);
	}
	...
	private boolean check_main_region_Table__region0_sync1_tr0_StoringGroceries_main_region__sync3join_check() {
		return isStateActive(State.main_region_Table__region1_sync1);
	}
	...
	private boolean check_main_region_Table__region1_sync1_tr0_StoringGroceries_main_region__sync3join_check() {
		return isStateActive(State.main_region_Table__region0_sync1);
	}
	...
	private boolean check_main_region_Copy_1_Table__region0_sync1_tr0_StoringGroceries_main_region__sync5join_check() {
	...
	private void effect_main_region_Composite_panCupboard_tiltCupboard__region0_doors_tr0() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0_doors();
		enterSequence_main_region_Composite_panCupboard_tiltCupboard__region0_wait_default();
	}
	
	private void effect_main_region_Composite_panCupboard_tiltCupboard__region0_wait_tr0() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0_wait();
		enterSequence_main_region_Composite_panCupboard_tiltCupboard__region0_sync1_default();
	}
	
	private void effect_main_region_Composite_panCupboard_tiltCupboard__region0_sync1_tr0() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard();
		react_main_region__sync1();
	}
	
	private void effect_main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard_tr0() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard();
		enterSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard_default();
	}
	
	private void effect_main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard_tr0() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard();
		enterSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1_default();
	}
	
	private void effect_main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira_tr0() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira();
		enterSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard_default();
	}
	
	private void effect_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1_tr0() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard();
		react_main_region__sync1();
	}
	
	private void effect_main_region_Table__region0_lookToFront_tr0() {
		exitSequence_main_region_Table__region0_lookToFront();
		enterSequence_main_region_Table__region0_sync1_default();
	}
	
	private void effect_main_region_Table__region0_sync1_tr0() {
		exitSequence_main_region_Table();
		react_main_region__sync3();
	}
	
	private void effect_main_region_Table__region1_Copy_1_panCupboard_tr0() {
		exitSequence_main_region_Table__region1_Copy_1_panCupboard();
		enterSequence_main_region_Table__region1_Copy_1_tiltCupboard_default();
	}
	
	private void effect_main_region_Table__region1_Copy_1_tiltCupboard_tr0() {
		exitSequence_main_region_Table__region1_Copy_1_tiltCupboard();
		enterSequence_main_region_Table__region1_sync1_default();
	}
	
	private void effect_main_region_Table__region1_sync1_tr0() {
		exitSequence_main_region_Table();
		react_main_region__sync3();
	}
	
	private void effect_main_region_Table__region1_wait_for_Mira_tr0() {
		exitSequence_main_region_Table__region1_wait_for_Mira();
		enterSequence_main_region_Table__region1_Copy_1_panCupboard_default();
	}
	...
	private void entryAction_main_region_Composite_panCupboard_tiltCupboard__region0_doors() {
		sCIHBrain.operationCallback.sendTTS("{90;-80}I want to see the objects in the cupboard. [:-(] But I don't have a manipulator to open the doors. [:-)] Can somebody help me please.");
	}
	
	/* Entry action for state 'wait'. */
	private void entryAction_main_region_Composite_panCupboard_tiltCupboard__region0_wait() {
	...
	private void exitAction_main_region_Composite_panCupboard_tiltCupboard__region0_wait() {
	...
	private void enterSequence_main_region_Composite_panCupboard_tiltCupboard__region0_doors_default() {
		entryAction_main_region_Composite_panCupboard_tiltCupboard__region0_doors();
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Composite_panCupboard_tiltCupboard__region0_doors;
	}
	
	/* 'default' enter sequence for state wait */
	private void enterSequence_main_region_Composite_panCupboard_tiltCupboard__region0_wait_default() {
		entryAction_main_region_Composite_panCupboard_tiltCupboard__region0_wait();
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Composite_panCupboard_tiltCupboard__region0_wait;
	}
	
	/* 'default' enter sequence for state sync1 */
	private void enterSequence_main_region_Composite_panCupboard_tiltCupboard__region0_sync1_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Composite_panCupboard_tiltCupboard__region0_sync1;
	}
	...
	/* 'default' enter sequence for state sync1 */
	private void enterSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1_default() {
		nextStateIndex = 1;
		stateVector[1] = State.main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1;
	}
	
	/* 'default' enter sequence for state lookToFront */
	private void enterSequence_main_region_Table__region0_lookToFront_default() {
		entryAction_main_region_Table__region0_lookToFront();
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Table__region0_lookToFront;
	}
	
	/* 'default' enter sequence for state sync1 */
	private void enterSequence_main_region_Table__region0_sync1_default() {
		nextStateIndex = 0;
		stateVector[0] = State.main_region_Table__region0_sync1;
	}
	
	/* 'default' enter sequence for state Copy_1_panCupboard */
	private void enterSequence_main_region_Table__region1_Copy_1_panCupboard_default() {
		entryAction_main_region_Table__region1_Copy_1_panCupboard();
		nextStateIndex = 1;
		stateVector[1] = State.main_region_Table__region1_Copy_1_panCupboard;
	}
	
	/* 'default' enter sequence for state Copy_1_tiltCupboard */
	private void enterSequence_main_region_Table__region1_Copy_1_tiltCupboard_default() {
		entryAction_main_region_Table__region1_Copy_1_tiltCupboard();
		nextStateIndex = 1;
		stateVector[1] = State.main_region_Table__region1_Copy_1_tiltCupboard;
	}
	
	/* 'default' enter sequence for state sync1 */
	private void enterSequence_main_region_Table__region1_sync1_default() {
		nextStateIndex = 1;
		stateVector[1] = State.main_region_Table__region1_sync1;
	}
	
	/* 'default' enter sequence for state wait for Mira */
	private void enterSequence_main_region_Table__region1_wait_for_Mira_default() {
		entryAction_main_region_Table__region1_wait_for_Mira();
		nextStateIndex = 1;
		stateVector[1] = State.main_region_Table__region1_wait_for_Mira;
	}
	...
	/* Default exit sequence for state Composite_panCupboard_tiltCupboard */
	private void exitSequence_main_region_Composite_panCupboard_tiltCupboard() {
		exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0();
		exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region();
	}
	
	/* Default exit sequence for state doors */
	private void exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0_doors() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	
	/* Default exit sequence for state wait */
	private void exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0_wait() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
		
		exitAction_main_region_Composite_panCupboard_tiltCupboard__region0_wait();
	}
	
	/* Default exit sequence for state sync1 */
	private void exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0_sync1() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	/* Default exit sequence for state sync1 */
	private void exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
	}
	
	/* Default exit sequence for state Table */
	private void exitSequence_main_region_Table() {
		exitSequence_main_region_Table__region0();
		exitSequence_main_region_Table__region1();
	}
	
	/* Default exit sequence for state lookToFront */
	private void exitSequence_main_region_Table__region0_lookToFront() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
		
		exitAction_main_region_Table__region0_lookToFront();
	}
	
	/* Default exit sequence for state sync1 */
	private void exitSequence_main_region_Table__region0_sync1() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	
	/* Default exit sequence for state Copy_1_panCupboard */
	private void exitSequence_main_region_Table__region1_Copy_1_panCupboard() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
		
		exitAction_main_region_Table__region1_Copy_1_panCupboard();
	}
	
	/* Default exit sequence for state Copy_1_tiltCupboard */
	private void exitSequence_main_region_Table__region1_Copy_1_tiltCupboard() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
		
		exitAction_main_region_Table__region1_Copy_1_tiltCupboard();
	}
	
	/* Default exit sequence for state sync1 */
	private void exitSequence_main_region_Table__region1_sync1() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
	}
	
	/* Default exit sequence for state wait for Mira */
	private void exitSequence_main_region_Table__region1_wait_for_Mira() {
		nextStateIndex = 1;
		stateVector[1] = State.$NullState$;
		
		exitAction_main_region_Table__region1_wait_for_Mira();
	}
	...
	private void exitSequence_main_region() {
		...
		case main_region_Composite_panCupboard_tiltCupboard__region0_wait:
			...
			break;
		case main_region_Composite_panCupboard_tiltCupboard__region0_sync1:
			exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0_sync1();
			break;
		case main_region_Table__region0_lookToFront:
			exitSequence_main_region_Table__region0_lookToFront();
			break;
		case main_region_Table__region0_sync1:
			exitSequence_main_region_Table__region0_sync1();
			break;
		case main_region_inspectTable_table_tellObj:
			exitSequence_main_region_inspectTable_table_tellObj();
			break;
		...
		case main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira:
			...
			break;
		case main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1:
			exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1();
			break;
		case main_region_Table__region1_Copy_1_panCupboard:
			exitSequence_main_region_Table__region1_Copy_1_panCupboard();
			break;
		case main_region_Table__region1_Copy_1_tiltCupboard:
			...
			break;
		case main_region_Table__region1_sync1:
			exitSequence_main_region_Table__region1_sync1();
			break;
		case main_region_Table__region1_wait_for_Mira:
			exitSequence_main_region_Table__region1_wait_for_Mira();
			break;
	...
	private void exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0() {
		switch (stateVector[0]) {
		case main_region_Composite_panCupboard_tiltCupboard__region0_doors:
			exitSequence_main_region_Composite_panCupboard_tiltCupboard__region0_doors();
			break;
	...
	private void exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region() {
		switch (stateVector[1]) {
		case main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard:
			exitSequence_main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard();
			break;
	...
	/* Default exit sequence for region null */
	private void exitSequence_main_region_Table__region0() {
		switch (stateVector[0]) {
		case main_region_Table__region0_lookToFront:
			exitSequence_main_region_Table__region0_lookToFront();
			break;
	...
	/* Default exit sequence for region null */
	private void exitSequence_main_region_Table__region1() {
		switch (stateVector[1]) {
		case main_region_Table__region1_Copy_1_panCupboard:
			exitSequence_main_region_Table__region1_Copy_1_panCupboard();
			break;
	...
	private void react_main_region_Composite_panCupboard_tiltCupboard__region0_doors() {
		if (check_main_region_Composite_panCupboard_tiltCupboard__region0_doors_tr0_tr0()) {
			effect_main_region_Composite_panCupboard_tiltCupboard__region0_doors_tr0();
		}
	}
	
	/* The reactions of state wait. */
	private void react_main_region_Composite_panCupboard_tiltCupboard__region0_wait() {
		if (check_main_region_Composite_panCupboard_tiltCupboard__region0_wait_tr0_tr0()) {
			effect_main_region_Composite_panCupboard_tiltCupboard__region0_wait_tr0();
		}
	}
	
	/* The reactions of state sync1. */
	private void react_main_region_Composite_panCupboard_tiltCupboard__region0_sync1() {
		if (check_main_region_Composite_panCupboard_tiltCupboard__region0_sync1_tr0_StoringGroceries_main_region__sync1join_check()) {
			effect_main_region_Composite_panCupboard_tiltCupboard__region0_sync1_tr0();
		}
	}
	...
	/* The reactions of state sync1. */
	private void react_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1() {
		if (check_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1_tr0_StoringGroceries_main_region__sync1join_check()) {
			effect_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1_tr0();
		}
	}
	
	/* The reactions of state lookToFront. */
	private void react_main_region_Table__region0_lookToFront() {
		if (check_main_region_Table__region0_lookToFront_tr0_tr0()) {
			effect_main_region_Table__region0_lookToFront_tr0();
		}
	}
	
	/* The reactions of state sync1. */
	private void react_main_region_Table__region0_sync1() {
		if (check_main_region_Table__region0_sync1_tr0_StoringGroceries_main_region__sync3join_check()) {
			effect_main_region_Table__region0_sync1_tr0();
		}
	}
	
	/* The reactions of state Copy_1_panCupboard. */
	private void react_main_region_Table__region1_Copy_1_panCupboard() {
		if (check_main_region_Table__region1_Copy_1_panCupboard_tr0_tr0()) {
			effect_main_region_Table__region1_Copy_1_panCupboard_tr0();
		}
	}
	
	/* The reactions of state Copy_1_tiltCupboard. */
	private void react_main_region_Table__region1_Copy_1_tiltCupboard() {
		if (check_main_region_Table__region1_Copy_1_tiltCupboard_tr0_tr0()) {
			effect_main_region_Table__region1_Copy_1_tiltCupboard_tr0();
		}
	}
	
	/* The reactions of state sync1. */
	private void react_main_region_Table__region1_sync1() {
		if (check_main_region_Table__region1_sync1_tr0_StoringGroceries_main_region__sync3join_check()) {
			effect_main_region_Table__region1_sync1_tr0();
		}
	}
	
	/* The reactions of state wait for Mira. */
	private void react_main_region_Table__region1_wait_for_Mira() {
		if (check_main_region_Table__region1_wait_for_Mira_tr0_tr0()) {
			effect_main_region_Table__region1_wait_for_Mira_tr0();
		}
	}
	...
	private void react_main_region_Copy_1_Table__region0_sync1() {
		if (check_main_region_Copy_1_Table__region0_sync1_tr0_StoringGroceries_main_region__sync5join_check()) {
	...
	private void react_main_region_Copy_1_Table__region1_sync1() {
		if (check_main_region_Copy_1_Table__region1_sync1_tr0_StoringGroceries_main_region__sync5join_check()) {
	...
	private void react_main_region__sync2() {
		enterSequence_main_region_Table__region0_lookToFront_default();
		enterSequence_main_region_Table__region1_wait_for_Mira_default();
	}
	...
	public void runCycle() {
		...
		for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
			...
			case main_region_requestReady:
				...
				break;
			case main_region_Composite_panCupboard_tiltCupboard__region0_doors:
				react_main_region_Composite_panCupboard_tiltCupboard__region0_doors();
				break;
			case main_region_Composite_panCupboard_tiltCupboard__region0_wait:
				react_main_region_Composite_panCupboard_tiltCupboard__region0_wait();
				break;
			case main_region_Composite_panCupboard_tiltCupboard__region0_sync1:
				react_main_region_Composite_panCupboard_tiltCupboard__region0_sync1();
				break;
			case main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard:
				react_main_region_Composite_panCupboard_tiltCupboard_inner_region_panCupboard();
				break;
			case main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard:
				react_main_region_Composite_panCupboard_tiltCupboard_inner_region_tiltCupboard();
				break;
			case main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira:
				react_main_region_Composite_panCupboard_tiltCupboard_inner_region_wait_for_Mira();
				break;
			case main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1:
				react_main_region_Composite_panCupboard_tiltCupboard_inner_region_sync1();
				break;
			case main_region_Table__region0_lookToFront:
				react_main_region_Table__region0_lookToFront();
				break;
			case main_region_Table__region0_sync1:
				react_main_region_Table__region0_sync1();
				break;
			case main_region_Table__region1_Copy_1_panCupboard:
				react_main_region_Table__region1_Copy_1_panCupboard();
				break;
			case main_region_Table__region1_Copy_1_tiltCupboard:
				react_main_region_Table__region1_Copy_1_tiltCupboard();
				break;
			case main_region_Table__region1_sync1:
				react_main_region_Table__region1_sync1();
				break;
			case main_region_Table__region1_wait_for_Mira:
				react_main_region_Table__region1_wait_for_Mira();
				break;
			case main_region_inspectTable_table_tellObj:
