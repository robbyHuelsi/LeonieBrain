...
public class BrainStatemachine implements IBrainStatemachine {
	...
	*/
	public boolean isStateActive(State state) {
		switch (state) {
			...
			case main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Composite_Emotion_Interpretation :
				return stateVector[0]
						.ordinal() >= State.main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Composite_Emotion_Interpretation
								.ordinal()
						&& stateVector[0]
								.ordinal() <= State.main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Composite_Emotion_Interpretation_inner_region_waitForNewEmo
										.ordinal();
			...
			case main_endOfStory :
				return stateVector[0] == State.main_endOfStory;
			case main__final_ :
			...
			case main_endeGutallesGut :
				return stateVector[0] == State.main_endeGutallesGut;
	...
	*/
	...
	private boolean check_main_endOfStory_tr0_tr0() {
		return sCIHBrain.tTSReady == true;
	}
	...
	private boolean check_main_endeGutallesGut_tr0_tr0() {
		return true;
	}
	...
	private boolean check_main_GreetingsToVisitors_inner_region_Copy_1_wait1_tr0_tr0() {
	...
	private boolean check_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Composite_Emotion_Interpretation_inner_region__choice_1_tr1_tr1() {
		return sCICurrPerson.currEmotion == 1 || sCICurrPerson.currEmotion == 4 || sCICurrPerson.currEmotion == 5;
	}
	...
	private void effect_main_Init_tr2() {
		...
		enterSequence_main_GreetingsToVisitors_entry_GreetingsToVisitors2();
	}
	...
	private void effect_main_endOfStory_tr0() {
		exitSequence_main_endOfStory();

		enterSequence_main_endeGutallesGut_default();
	}
	...
	private void effect_main_GreetingsToVisitors_inner_region_Greeting1_tr0() {
		...
		enterSequence_main_GreetingsToVisitors_inner_region_Copy_1_wait1_default();
	}

	private void effect_main_GreetingsToVisitors_inner_region_Copy_1_wait1_tr0() {
	...
	private void effect_main_mainStorry_inner_region__choice_0_tr1() {
		...
		enterSequence_main_endOfStory_default();
	}
	...
	private void entryAction_main_endOfStory() {
		sCIHBrain.setTTSReady(false);

		sCIUdpInterface.operationCallback.sendToSTT_detectionOnOff(0);

		sCIUdpInterface.operationCallback.sendToHBrain_TTS(
				"[:-D]puuuh I met so many interesting people! I was waiting so long for this moment. You know my friends were in a big hurry to prepare me for this. Safe collaborative robots that can understand and learn the human actions and emotions, certainly paves the way for a better tomorrow! The team RT Lions is working hard to make me more and more intelligent. The future is already here!");
	}
	...
	private void entryAction_main_endeGutallesGut() {
		sCIUdpInterface.operationCallback.sendToVBrain_ACIonOff(false);
	...
	private void entryAction_main_GreetingsToVisitors_inner_region_GreetingsToVisitors() {
		...
		sCIUdpInterface.operationCallback.sendToHBrain_TTS(
				"I’m so nervous. [-.-]ok I have to introduce myself. [:-)]I’m a helpful Robot in your smart home. [blush:false]But the special thing is, that I try to interact like a real Person. Look at my breathing.");
	}
	...
	private void entryAction_main_GreetingsToVisitors_inner_region_Greeting1() {
		sCIUdpInterface.operationCallback.sendToHBrain_TTS("[:-O]wow! so many people! [blush:true] {0;0} [idle3:true]");
	}

	/* Entry action for state 'Copy_1_wait1'. */
	...
	/* Exit action for state 'waitForNewEmo'. */
	private void exitAction_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Composite_Emotion_Interpretation_inner_region_waitForNewEmo() {
	...
	/* Exit action for state 'Copy_1_wait1'. */
	private void exitAction_main_GreetingsToVisitors_inner_region_Copy_1_wait1() {
	...
	private void enterSequence_main_endOfStory_default() {
		entryAction_main_endOfStory();

		nextStateIndex = 0;
		stateVector[0] = State.main_endOfStory;
	}
	...
	private void enterSequence_main_endeGutallesGut_default() {
		entryAction_main_endeGutallesGut();

		nextStateIndex = 0;
		stateVector[0] = State.main_endeGutallesGut;
	}

	/* 'entry_GreetingsToVisitors2' enter sequence for state GreetingsToVisitors */
	private void enterSequence_main_GreetingsToVisitors_entry_GreetingsToVisitors2() {
		enterSequence_main_GreetingsToVisitors_inner_region_entry_GreetingsToVisitors2();
	}
	...
	/* 'default' enter sequence for state Copy_1_wait1 */
	private void enterSequence_main_GreetingsToVisitors_inner_region_Copy_1_wait1_default() {
		entryAction_main_GreetingsToVisitors_inner_region_Copy_1_wait1();
	...
	/* 'entry_GreetingsToVisitors2' enter sequence for region inner region */
	private void enterSequence_main_GreetingsToVisitors_inner_region_entry_GreetingsToVisitors2() {
		react_main_GreetingsToVisitors_inner_region_entry_GreetingsToVisitors2();
	}
	...
	private void exitSequence_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Composite_Emotion_Interpretation_inner_region_waitForNewEmo() {
		...
		exitAction_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Composite_Emotion_Interpretation_inner_region_waitForNewEmo();
	}
	...
	private void exitSequence_main_endOfStory() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	/* Default exit sequence for state Copy_1_wait1 */
	private void exitSequence_main_GreetingsToVisitors_inner_region_Copy_1_wait1() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	...
	private void react_main_endOfStory() {
		if (check_main_endOfStory_tr0_tr0()) {
			effect_main_endOfStory_tr0();
		}
	}
	...
	private void react_main_endeGutallesGut() {
	...
	/* The reactions of state Copy_1_wait1. */
	private void react_main_GreetingsToVisitors_inner_region_Copy_1_wait1() {
		if (check_main_GreetingsToVisitors_inner_region_Copy_1_wait1_tr0_tr0()) {
			effect_main_GreetingsToVisitors_inner_region_Copy_1_wait1_tr0();
		}
	}
	...
	/* Default react sequence for initial entry entry_GreetingsToVisitors2 */
	private void react_main_GreetingsToVisitors_inner_region_entry_GreetingsToVisitors2() {
