		...
		switch (state) {
			case main_mainStorry :
				return stateVector[0].ordinal() >= State.main_mainStorry.ordinal()
						&& stateVector[0].ordinal() <= State.main_mainStorry_inner_region_Copy_1_exitSad.ordinal();
