package org.yakindu.scr.intrort;
import org.yakindu.scr.ITimer;

public class IntroRTStatemachine implements IIntroRTStatemachine {
	...
	*/
	public boolean isStateActive(State state) {
		...
		case main_leave2:
			return stateVector[0] == State.main_leave2;
	...
	*/
	...
	private boolean check_main_leave2_tr0_tr0() {
		return sCIHBrain.tTSReady;
	}
	...
	private void effect_main_LeapMotion_tr0() {
		...
		enterSequence_main_leave2_default();
	}
	...
	private void effect_main_LeapMotion_LeapMotion_in_OpenChallenge_ByeBye_tr0() {
		...
		react_main_LeapMotion_LeapMotion_in_OpenChallenge_exit_leapmotion();
	}
	...
	private void effect_main_leave2_tr0() {
		exitSequence_main_leave2();
	...
	private void entryAction_main_GreetingsToVisitors_inner_region_STTIntro() {
		...
		sCIHBrain.operationCallback.sendTTS("To understand humans I have a tough Speech to Text and Natural Language Processing System. However, if I don't know the answer of a question, I can ask web services like Wolfram Alpha., with all these awesome features and capabilities my team and i won the portugese open in braganza last year, and just a week ago we were in the finals of the german open in magdeburg! have a nice day!");
	}
	...
	private void entryAction_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_StartSTT() {
		...
		sCIHBrain.operationCallback.sendTTS("[:-)] Should I turn myself?");
	}
	...
	private void entryAction_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_Left() {
		...
		sCIHBrain.operationCallback.sendTTS("[excited] Yes, okay.");
	}
	...
	private void entryAction_main_leave2() {
		sCIHBrain.operationCallback.sendTTS("That was my small presentation. [:-0] Thanks for your attention. I hope your enjoed your time here. See us in Japan again. [:-)]");
	}
	...
	private void enterSequence_main_leave2_default() {
		entryAction_main_leave2();
		nextStateIndex = 0;
		stateVector[0] = State.main_leave2;
	}
	...
	private void exitSequence_main_leave2() {
		nextStateIndex = 0;
		stateVector[0] = State.$NullState$;
	}
	...
	private void react_main_LeapMotion_LeapMotion_in_OpenChallenge_Text() {
		if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_Text_tr0_tr0()) {
			effect_main_LeapMotion_LeapMotion_in_OpenChallenge_Text_tr0();
		} else {
			if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_Text_tr1_tr1()) {
				effect_main_LeapMotion_LeapMotion_in_OpenChallenge_Text_tr1();
			}
		}
	}
	...
	private void react_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_StartSTT() {
		if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_StartSTT_tr0_tr0()) {
			effect_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_StartSTT_tr0();
		} else {
			if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_StartSTT_tr1_tr1()) {
				effect_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_StartSTT_tr1();
			}
		}
	}
	...
	private void react_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_Left() {
		if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_Left_tr0_tr0()) {
			effect_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_Left_tr0();
		}
	}
	...
	private void react_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_Right() {
		if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_Right_tr0_tr0()) {
			effect_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_Right_tr0();
		}
	}
	...
	private void react_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_count() {
		effect_main_LeapMotion_LeapMotion_in_OpenChallenge_Detect_LeftRight_main_region_count_tr0();
	}
	
	/* The reactions of state ByeBye. */
	private void react_main_LeapMotion_LeapMotion_in_OpenChallenge_ByeBye() {
		if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_ByeBye_tr0_tr0()) {
			effect_main_LeapMotion_LeapMotion_in_OpenChallenge_ByeBye_tr0();
		} else {
			if (check_main_LeapMotion_LeapMotion_in_OpenChallenge_ByeBye_tr1_tr1()) {
				effect_main_LeapMotion_LeapMotion_in_OpenChallenge_ByeBye_tr1();
			}
		}
	}
	...
	private void react_main_leave2() {
		if (check_main_leave2_tr0_tr0()) {
			effect_main_leave2_tr0();
		}
	}
	...
	private void react_main_LeapMotion_LeapMotion_in_OpenChallenge_exit_leapmotion() {
