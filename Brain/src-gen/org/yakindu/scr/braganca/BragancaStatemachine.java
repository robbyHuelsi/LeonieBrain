...
public class BragancaStatemachine implements IBragancaStatemachine {
	...
	*/
	...
	private boolean check_main_mainStorry_inner_region_FaceDataInterpretation_tr1_tr1() {
		return sCIKinect2.noiseDetected && sCIBGF.getEventNum()==2;
	}
	...
	private boolean check_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_STT3_tr1_tr1() {
		return sCISTT.textReceived;
	}
	...
	private boolean check_main_GoToGWP0_tr1_tr1() {
		return sCIMira.arrivedWP;
	}
	
	private boolean check_main_GoToGWP0_tr2_tr2() {
		return 1==0;
	}
	
	private boolean check_main_GoToGWP0_tr3_tr3() {
		return 1==0;
	}
	...
	private boolean check_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_Yes_No_Question_inner_region__choice_1_tr0_tr0() {
		return (sCISTT.operationCallback.getText()== null?"yes" ==null :sCISTT.operationCallback.getText().equals("yes"));
	}
	...
	private boolean check_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_Yes_No_Question_inner_region__choice_1_tr1_tr1() {
		return (sCISTT.operationCallback.getText()== null?"no" ==null :sCISTT.operationCallback.getText().equals("no"));
	}
	...
	private void effect_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_STT3_tr1() {
		exitSequence_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_STT3();
	...
	private void effect_main_GoToGWP0_tr1() {
		exitSequence_main_GoToGWP0();
		enterSequence_main_GreetingsToVisitors_default();
	}
	
	private void effect_main_GoToGWP0_tr2() {
		exitSequence_main_GoToGWP0();
		enterSequence_main_AtWP03_FingerAlphabet__default();
	}
	
	private void effect_main_GoToGWP0_tr3() {
		exitSequence_main_GoToGWP0();
		enterSequence_main_randTest_default();
	}
	...
	private void entryAction_main_mainStorry_inner_region_exitNoise() {
		sCIHBrain.operationCallback.sendTTS("[:-|]Oh, some noise behind me! I have to leave you. Bye!");
	}
	...
	private void entryAction_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_Answere_name__and_ask() {
		setNameBuffer(sCISTT.operationCallback.getText());
	...
	private void entryAction_main_mainStorry_inner_region_Copy_1_exitSad() {
		...
		sCIHBrain.operationCallback.sendTTS("Who called me?");
	}
	...
	private void entryAction_main_Interrupt_Normal_Process() {
		...
		sCIHBrain.operationCallback.sendTTS("[:-(] I am lost.! I will go back to where I started.");
	...
	private void entryAction_main_GreetingsToVisitors_inner_region_Copy_1_greeting4() {
		sCIHBrain.operationCallback.sendTTS("Enough for the moment. [:-)] I want to talk to a real person in my kitchen now! [idle3:true]");
	}
	...
	private void entryAction_main_endeGutallesGut_inner_region_drive() {
		...
		sCIHBrain.operationCallback.sendTTS("[:-D]");
	}
		...
		if (check_main_mainStorry_tr0_tr0()) {
			...
			if (check_main_mainStorry_inner_region_FaceDataInterpretation_tr1_tr1()) {
				...
				if (check_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_STT3_tr0_tr0()) {
					...
					if (check_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_STT3_tr1_tr1()) {
						effect_main_mainStorry_inner_region_FaceDataInterpretation_FaceDataInterpretation_Getting_Name_AskForName_STT3_tr1();
					}
				}
			}
		}
	...
	private void react_main_GoToGWP0() {
		if (check_main_GoToGWP0_tr0_tr0()) {
			...
			if (check_main_GoToGWP0_tr1_tr1()) {
				effect_main_GoToGWP0_tr1();
			} else {
				if (check_main_GoToGWP0_tr2_tr2()) {
					effect_main_GoToGWP0_tr2();
				} else {
					if (check_main_GoToGWP0_tr3_tr3()) {
						effect_main_GoToGWP0_tr3();
					}
				}
			}
		}
